...
public interface IBoundedElement<out TSelf> where TSelf : ImmediateElement, IBoundedElement<TSelf>, IBoundedElement
{
...
public static class IBoundsExtensions
{
    ...
    public static T Bounds<T>(this T element, Bounds bounds) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Size<T>(this T element, Vector2 size) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Size<T>(this T element, float x, float y) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Size<T>(this T element, float v) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Pos<T>(this T element, Vector2 pos) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Pos<T>(this T element, float x, float y) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Pos<T>(this T element, float v) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Min<T>(this T element, Vector2 min) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Min<T>(this T element, float x, float y) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Min<T>(this T element, float v) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Max<T>(this T element, Vector2 max) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Max<T>(this T element, float x, float y) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Max<T>(this T element, float v) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Center<T>(this T element, Vector2 center) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Center<T>(this T element, float x, float y) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
    ...
    /// <returns> The element </returns>
    public static T Center<T>(this T element, float v) where T : ImmediateElement, IBoundedElement<T>, IBoundedElement {
