...
using OsmiumEditor.Source.EssentialsModule;
using OsmiumNucleus;
...
public class NewEditorOverhead : EditorWindow
{
    protected internal override void Create() {
        ...
        EditorWindowHierarchy.Add<ComponentHierarchy>();
        EditorWindowHierarchy.Add<SceneHierarchy>();
        EditorWindowHierarchy.Add<PlayButton>();
        //EditorWindowHierarchy.Add<MessingWithTrees>();
    }
}