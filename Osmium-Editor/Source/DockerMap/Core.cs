...
public static partial class DockerMap
{
    ...
    public static bool IsFrozen => Osmium.IsRunning;
    ...
    public static SerializedScene? FindMappedScene(OsmiumNucleus.Scene __targetScene) {
    ...
    public static void OnSceneAdded(OsmiumNucleus.Scene scene) {
        Scenes.Add(new SerializedScene(scene));
    }

    public static void OnSceneRemoved(OsmiumNucleus.Scene scene) {
